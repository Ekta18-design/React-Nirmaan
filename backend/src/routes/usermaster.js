...
router.get('/', (req, res) => {
  const query = 'CALL stp_UserMaster(1, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL)';
...
router.post('/', (req, res) => {
  ...
  const params = [username, user_firstname, user_lastname, user_email, user_phone, user_password, user_confirmpassword, role, isactive, isdeleted];
...
router.get('/:userid', (req, res) => {
  const query = 'CALL stp_UserMaster(4, ?, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL)';
...
router.put('/:userid', (req, res) => {
  ...
  const params = [userid, username, user_firstname, user_lastname, user_email, user_phone, user_password, user_confirmpassword, role, isactive, isdeleted];
...
router.delete('/:userid', (req, res) => {
  const query = 'CALL stp_UserMaster(5, ?, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL)';
  const params = [req.params.userid];
